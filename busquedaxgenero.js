window.addEventListener("load", function (){
  ...
  //console.log(genero);
   ...
   fetch("https://api.themoviedb.org/3/genre/tv/list" + idGenero + "?api_key=a6f60714320c532cb6f1c6ddeef46bac&language=en-US")
...
//   document.querySelector("h1.title").innerText = "Resultado de ''" + respuesta.name + "''";
